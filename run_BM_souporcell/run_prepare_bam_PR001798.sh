#!/usr/bin/env bash
#SBATCH -J sort_bam_PR001798  # Job name
...
in_dir="../data/Janssens_Lab_Data/BMMC_Bams/PR001798_sciCoCnT_JAND_DNA_ALIGNMENT_WELLID_BARCODES/BAM"
out_dir="./tmp/PR001798_bam/"
mkdir -p "$out_dir"
...
samtools sort -m 7G -@ $threads -o "${out_dir}/merged.sorted.bam" "${out_dir}/merged.bam"
