##################################################
## Script: run_n_get_signature_genes_round1.R
## Purpose: Identify marker genes for clusters defined in ArchR projects for H3K27me3, H3K4me1, H3K4me2, and H3K4me3 datasets using the GeneScoreMatrix and Wilcoxon test
## INPUT:
...
## * ./tmp/table_marker_genes_all_clusters_both_directions_round1.tsv
...
## * ./tmp/markersGS_list_round1.rds
## * ./tmp/markersGS_list_round1_match.rds
##
...
## Load project
proj_h3k27 = loadArchRProject("./tmp/H3K27me3_coCnT_final1/")
proj_h3k4me1 = loadArchRProject("./tmp/H3K4me1_coCnT_final1/")
proj_h3k4me2 = loadArchRProject("./tmp/H3K4me2_coCnT_final1/")
proj_h3k4me3 = loadArchRProject("./tmp/H3K4me3_coCnT_final1/")
...
write_rds(markersGS_list, "./tmp/markersGS_list_round1.rds")

## Get marker genes
markersGS_list = read_rds("./tmp/markersGS_list_round1.rds")
...
write_tsv(markerList_all_dt, "./tmp/table_marker_genes_all_clusters_both_directions_round1.tsv")
...
write_rds(markersGS_list, "./tmp/markersGS_list_round1_match.rds")

## Get marker genes
markersGS_list = read_rds("./tmp/markersGS_list_round1_match.rds")
...
write_tsv(markerList_all_dt, "./tmp/table_marker_genes_all_clusters_both_directions_round1_match.tsv")
