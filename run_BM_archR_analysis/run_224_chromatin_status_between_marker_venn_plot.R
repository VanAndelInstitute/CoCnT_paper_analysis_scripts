...
pdf("./figures/figure_chromatin_status_bivalent_venn.pdf", width = 6, height = 6)
...
ggsave("./figures/figure_chromatin_status_bivalent_venn_hspc_enrichment.pdf", width = 6, height = 6)
