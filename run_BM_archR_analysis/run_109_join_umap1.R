##################################################
## Script: run_n_join_umap1.R
## Purpose: Join UMAP embeddings from multiple ArchR projects
## INPUT:
...
## - Figures of combined UMAP embeddings colored by clusters:
## * ./figures/109_join_umap1.pdf
##
...
pdf("./figures/109_join_umap1.pdf", width = 12, height = 10)
